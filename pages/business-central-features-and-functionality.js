  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Microsoft Power Virtual Agents: Enhance CRM Capabilities" />
        ...
        <meta property="og:url" content="https://www.dynamicssquare.ca/business-central-features-and-functionality/" />
        <meta property="og:site_name" content="Dynamics Square CA" />
        <meta property="og:image" content="https://www.dynamicssquare.co.uk/img/BC-feature-banner.png" />
        ...
        <meta name="twitter:image" content="https://www.dynamicssquare.co.uk/img/BC-feature-banner.png" />
        {/* <script
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 col-md-8">
                ...
                <p>Discover an all-in-one business management solution with <b>Dynamics 365 Business Central</b> (formerly <Link href="/solutions/microsoft-dynamics-nav/"><a>Dynamics NAV</a></Link> or Navision). <b>D365 Business Central</b> offers different modules to tackle any business structure. The seamless integration with other <b>Microsoft cloud services</b> and customizable features with Power Apps, Power Automate, and <Link href="/solutions/microsoft-power-bi/"><a>Power BI</a></Link> make <b>Business Central</b> stand out.</p>
                <p>Trusted by over 160k customers worldwide, it streamlines processes, automates tasks, and enhances <b>customer engagement</b>, <Link href="/solutions/microsoft-dynamics-365-finance-operations/"><a>managing finances & operations</a></Link>, sales, and customer service. Upgrade from entry-level accounting software or legacy ERP systems and revolutionize your business with <b>Dynamics 365 Business Central's</b> single, end-to-end solution.</p>
              </header>
            </div>
          </div>
        </div>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8 col-md-8">
            <header className="section-header">
              ...
              <p><Link href="/solutions/dynamics-365-business-central/"><a>Business Central</a></Link> offers flexible pricing and licensing options that nicely fit the needs of businesses of all sizes.</p>
            </header>
          </div>
        </div>
              ...
              <div className="finace-acc">
                <div className="accordion" id="accnew">
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                      <p>Business Central helps you with its comprehensive <Link href="/solutions/microsoft-dynamics-365-finance/"><a>financial management capabilities</a></Link>, including accounts payable and receivable, general ledger, fixed assets, and cash management.</p>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        <p><b>Dynamics 365 Business Central</b> enables businesses to manage their <Link href="/solutions/dynamics-365-supply-chain-management/"><a>supply chain operations</a></Link> efficiently, from procurement to inventory management and production.</p>
              ...
              <div className="finace-acc">
                ...
                <div className="accordion" id="accnews">
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                      <p><b>Microsoft Business Central</b> provides you with a complete set of <Link href="/solutions/microsoft-dynamics-365-sales/"><a>dynamics 365 sales</a></Link> and <b>service management tools</b>, including <b>customer relationship management (CRM)</b>, sales order processing, service order management, and project management.</p>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                       <p><b>Dynamics 365 Business Central</b> assists businesses to manage their <Link href="/solutions/dynamics-365-human-resources/"><a>human resources (HR) operations</a></Link>, from recruiting and onboarding to performance management and payroll.</p>
            ...
            <div className="style-grid-1">
              ...
              <div className="style-grid-1">
                <div className="style-grid-content">
                  ...
                  <p>Business Central is designed to grow as your business grows. With its flexible architecture and <Link href="/solutions/microsoft-dynamics-365/"><a>seamless integration with other Microsoft products</a></Link>, this cloud ERP can adapt to your changing business needs and enable you to scale your operations efficiently.</p>
                </div>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="style-grid-1">
                <div className="style-grid-content">
                  ...
                  <p><Link href="/solutions/dynamics-365-business-central/"><a>Microsoft Dynamics 365 Business Central</a></Link> is a cloud-based solution that enables you to access your business data and applications from anywhere, anytime. With this user-friendly solution, you can work from home, on the go, or from any device, ensuring that you can always stay connected to your business.</p>
                </div>
              </div>
              ...
              <div className="style-grid-1">
                <div className="style-grid-content">
                  ...
                  <p><Link href="/solutions/microsoft-azure/"><a>Microsoft Azure</a></Link>, <b>Microsoft Cloud</b>, and Dataverse power <b>Dynamics 365 Business Central</b> to offer enterprise-grade security and compliance features for your business, ensuring that your business data is secure and compliant with regulatory requirements. You can protect your business data from cyber threats, reduce data loss, and more. </p>
                </div>
              </div>
            </div>
          </div>

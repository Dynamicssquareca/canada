  ...
  return (
    <>
      ...
      <title>Dynamics 365 Support & Services | Dynamics Square CA</title>
        ...
        <meta property="og:title" content="Dynamics 365 Support & Services | Dynamics Square CA" />
        <meta property="og:description" content="Dynamics Square is Canada's leading high-quality support for Dynamics 365, Dynamics NAV, AX,GP, & Managed Services. Contact us for instant help." />
        <meta property="og:url" content="https://www.dynamicssquare.ca/services/dynamics-365-support/" />
        <meta property="og:site_name" content="Dynamics Square CA" />
        <meta property="og:image" content="https://www.dynamicssquare.ca/img/support-service-banner.png" />
        <meta property="og:image:width" content="200" />
        <meta property="og:image:height" content="200" />
        <meta property="og:image:type" content="image/png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@dsquare_ca" />
        <meta name="twitter:title" content="Dynamics 365 Support & Services | Dynamics Square CA" />
        <meta name="twitter:description" content="Dynamics Square is Canada's leading high-quality support for Dynamics 365, Dynamics NAV, AX,GP, & Managed Services. Contact us for instant help." />
        <meta name="twitter:image" content="https://www.dynamicssquare.ca/img/support-service-banner.png" />
         {/* <script
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 mobile-4 align-self-center">
              ...
              <p>Maintain, optimize, and re-invent your <Link href="/solutions/microsoft-dynamics-erp/"><a>Dynamics 365 ERP and CRM Systems</a></Link> with Dynamics Square's Support Services.</p>
              <div>
          ...
          <div className="row p-lg-6">
            <div className="col-lg-5 align-self-center">
              <div className="side-heding-new">
                ...
                <p>We have all you need to drive innovation. By intelligently connecting your processes, data sources, and people close to your business to a single intuitive business management platform like <Link href="/solutions/dynamics-365-business-central/"><a>Dynamics 365 Business Central</a></Link>, <Link href="/solutions/microsoft-power-bi/"><a>Microsoft Power BI</a></Link>, <Link href="/solutions/dynamics-365-supply-chain-management/"><a>Dynamics 365 Supply Chain</a></Link>, or other business-centric modules while providing training, customization, and tech consultancy we help you accelerate your business.</p>
              </div>
            </div>

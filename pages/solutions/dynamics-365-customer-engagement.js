          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <header className="section-header">
                ...
                <p>Dynamics 365 customer engagement (formerly known as <Link href="/solutions/microsoft-dynamics-crm/">Microsoft Dynamics CRM</Link>) is a single cloud-based, analytics-driven robust customer engagement platform. Dynamics 365 Customer Engagement uniquely brings CRM (customer relationship management), CDP (customer data platforms), and CXM (customer experience management) into one entity, allowing you to manage the entire customer journey and lifecycle.</p>
              </header>
            </div>
          </div>
        </div>
          ...
          <div className="row pad15x">
            ...
            <div className="col-lg-4 align-self-center">
              <div className="commen-box-3">
                ...
                <div className="commen-boc-3-info">
                  <p>With our 11+ years of experience implementing different <Link href="/solutions/microsoft-dynamics-365/"><a>Dynamics 365 modules</a></Link>, you get skilled and Microsoft-certified consultants you can trust.</p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 align-self-center">
          ...
          <div className="row pad9x rever-1">
            ...
            <div className="col-lg-5 align-self-center">
              <div className="commen-rit-info">
                ...
                <p>Maximize your revenue by understanding your customers using in-depth AI-based sales analytics in <Link href="/solutions/microsoft-dynamics-365-sales/"><a>Dynamics 365 Sales</a></Link>. </p>
              </div>
            </div>
          </div>
          ...
          <div className="row pad9x rever-1">
            ...
            <div className="col-lg-5 align-self-center">
              <div className="commen-rit-info">
                ...
                <p>Empower customers with self-service choices, help support agents swiftly answer customer concerns using <Link href="/solutions/microsoft-dynamics-365-ai/"><a>AI-powered insights</a></Link> and <Link href="/solutions/azure-iot-internet-of-things/"><a>optimize service operations with IoT solutions</a></Link>.</p>
              </div>
            </div>
          </div>
          ...
          <div className="row pad9x">
            <div className="col-lg-5 align-self-center">
              <div className="commen-rit-info">
                ...
                <p>Provide a highly connected service experience with <Link href="/solutions/microsoft-dynamics-365-field-service/"><a>Dynamics 365 Field Service</a></Link> module and increase your staff's performance for enhanced service operations efficiency.</p>
              </div>
            </div>
            <div className="col-lg-7 align-self-center">
              <div className="commen-lef-pic">
            ...
            <div className="col-lg-6">
              ...
              <div className="style-grid-1">
                ...
                <div className="style-grid-content">
                  ...
                  <p>Harness predictive sales & marketing insights from <Link href="/solutions/microsoft-dynamics-365/"><a>Microsoft business apps</a></Link> to predict how to serve your customers better. </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6">

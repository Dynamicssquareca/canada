  ...
  return (
    <>
      ...
      <title>Microsoft Dynamics CRM Solution|Dynamics Square CA</title>
        ...
        <link
          rel="canonical"
          href="https://www.dynamicssquare.ca/solutions/microsoft-dynamics-crm/"
        />
          ...
          <div className="row pad9x">
            <div className="col-lg-5 align-self-center">
              <div className="commen-rit-info">
                ...
                <div className="cltt-actt">
                  <Link href="/solutions/microsoft-dynamics-365-customer-service/">
                    Learn More
                  </Link>
                </div>
              </div>
          ...
          <div className="row pad9x rever-1">
            ...
            <div className="col-lg-6 align-self-center">
              <div className="commen-rit-info">
                ...
                <div className="cltt-actt">
                  <Link href="/solutions/microsoft-dynamics-365-marketing/">
                    Learn More
                  </Link>
                </div>
              </div>
          ...
          <div className="row pad9x">
            <div className="col-lg-5 align-self-center">
              <div className="commen-rit-info">
                ...
                <div className="cltt-actt">
                  <Link href="/solutions/dynamics-365-project-operations/">
                    Learn More
                  </Link>
                </div>
              </div>

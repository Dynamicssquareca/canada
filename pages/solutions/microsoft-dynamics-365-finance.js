              ...
              <div className="col-lg-9">
                <div className="hero-bnner-info text-center">
                  ...
                  <div className="top-info-img text-center">
                    <Image src="/img/Mirc-finace-banner.png" alt="c-erp-partner-banner"  width={932} height={531} priority={true} sizes="(max-width: 600px) 100vw, (min-width: 601px) 50vw, 932px" />
                  </div>
                  <div className="bottom-info-cta">
                    <a data-bs-toggle="modal"
                      href="#exampleModal" className="btn">Let’s Get Started!</a>
                    <span>Improve your finance practices</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container">
            ...
            <div className="row">
                ...
                <div className="card-five">
                  ...
                  <div className="info-card">
                    ...
                    <div className="act-bb">
                      <a href="#exampleModal" data-bs-toggle="modal">Unlock Growth! <i className="bi bi-arrow-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-xl-4 col-lg-4 col-md-6 d-flex">
                <div className="card-five">
                  <div className="pic">
                    <a href="#exampleModal" data-bs-toggle="modal"><Image src="/img/serv-img-2.jpg" alt="Upgrade Services" width={829} height={368} /></a>
                  </div>
                  <div className="info-card">
                    ...
                    <div className="act-bb">
                      <a href="#exampleModal" data-bs-toggle="modal">Switch to Tech! <i className="bi bi-arrow-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <header className="section-header-new">
                  ...
                  <p>Dynamics Square, a leading Microsoft Solutions Provider, is known for its expertise, reliability, and customer-centric approach.</p>
                </header>
              </div>
            </div>
            ...
            <div className="row g-3">
              <div className="col-lg-6 d-flex">
                <div className="card-seven">
                  ...
                  <a href="#exampleModal" data-bs-toggle="modal" className="btn bt-bg">Try Now!</a>
              ...
              <div className="col-lg-6 d-flex">
                <div className="card-seven card-w">
                  ...
                  <a href="#exampleModal" data-bs-toggle="modal" className="btn bt-bg">Optimize Your Operations!</a>
                  <div className="bg-r-img">
                    <img src="/img/micrsoft-nva-ds-bott.png" alt="micrsoft-nva-ds-bott" width={144} height={144} />
                  </div>
                </div>

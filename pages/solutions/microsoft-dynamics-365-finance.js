                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay">
                        <p>
                        Integrating Microsoft's Dynamics 365 Finance helps you streamline your business ops is a decisive move. This cloud <Link href="/solutions/microsoft-dynamics-erp/"><a>ERP Solution</a></Link> assists you monitor cash flows, forecast profit margins, report generating, and lot more.  capabilities. 
                        </p>
                      </div>
                    </div>
                    <div className="why-solution-wrapper-inner">
              ...
              <div className="accordion accordion-flush" id="faqlist1">
                ...
                <div className="accordion-item">
                  ...
                  <div
                    ...
                    data-bs-parent="#faqlist1"
                  >
                    <div className="accordion-body"><p><Link href="/solutions/microsoft-dynamics-365/"><a>Microsoft Dynamics 365</a></Link> is a comprehensive solution created to assist contemporary financial practices in today's well-equipped businesses that operate internationally while contending with intense industry rivalry. Hence, businesses may incur setup fees of $180 per user per month for the first Dynamics 365 app and $30 for each additional eligible Dynamics 365 app. To find out more about the license for Dynamics 365 Finance, <Link href="/contact-us/"><a>get in touch with our experts</a></Link>.</p></div>
                  </div>
                </div>
                <div className="accordion-item">
                  <h3 className="accordion-header">

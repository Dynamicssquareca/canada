              ...
              <div className="finace-acc">
                ...
                <hr className="mob-disp" />
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        <p>Powered by <Link href="/solutions/microsoft-dynamics-365-ai/"><a>Microsoft AI technology</a></Link> Power Automate not only helps you easily drive automation but also assists in several ways. Get started with creating new flows based on your business model.</p>
                      </div>
                    </div>
                  </div>
                  <hr />

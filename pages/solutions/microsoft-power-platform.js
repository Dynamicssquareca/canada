      ...
      <section className="new-bg">
        <div className="container">
          <div className='row justify-content-center'>
            ...
            <p>The Microsoft Power Platform is a group of five powerful applications to help you build a sustainable business by simplifying complex processes using different applications. <Link href="/solutions/microsoft-power-bi/"><a>Power BI</a></Link>, <b>Power Apps, Power Pages,</b> <Link href="/solutions/microsoft-power-automate/"><a>Power Automate</a></Link>, and <Link href="/solutions/microsoft-power-virtual-agents/"><a>Power Virtual Agents</a></Link> are all part of it. These applications let the user harness the full potential of processes and data to run the business efficiently.</p>
          </header>
            </div>
          </div>
        </div>
            ...
            <div className="col-lg-8 align-self-center">
              <div className="commen-rit-info">
                ...
                <div className="cltt-actt">
                  <a href="/solutions/microsoft-power-bi/">Find Out More</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row pad9x">
            <div className="col-lg-8 align-self-center">
              <div className="commen-rit-info">
                ...
                <p>
                If you want to build a complex business application but don't want to code for it, <Link href="/solutions/microsoft-power-apps/"><a>Microsoft Power Apps</a></Link> would be a life-saving solution for you. You can create applications without any coding knowledge in a fast and agile way. Also, you can easily develop applications from scratch using predefined templates or formats. 
                </p>
                <div className="cltt-actt">
                  <a href="/solutions/microsoft-power-apps/">Get Started</a>
                </div>
              </div>
            </div>
            <div className="col-lg-4 align-self-center ">
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      <p>By integrating Power Platform apps built by your team with <Link href="/solutions/microsoft-dynamics-365/"><a>Microsoft Dynamics 365</a></Link>, or <Link href="/solutions/microsoft-azure/"><a>Azure</a></Link>, organizations can break down traditional data silos and move toward digital success.</p>
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <p>Power Apps is a platform for creating applications that is a part of <b>Microsoft Power Platform</b> and utilizes <b>Azure cloud services</b>. All <b>Dynamics 365 applications</b> — <Link href="/solutions/microsoft-dynamics-365-sales/"><a></a></Link>, <Link href="/solutions/microsoft-dynamics-365-customer-service/"><a>Customer Service</a></Link>, <Link href="/solutions/microsoft-dynamics-365-field-service/"><a>Field Service</a></Link>, <Link href="/solutions/microsoft-dynamics-365-marketing/"><a>Marketing</a></Link>, and <b>Talent Acquisition</b> — are built natively on the platform.</p>
                    </div>
                  </div>
                </div>
                <div className="accordion-item">

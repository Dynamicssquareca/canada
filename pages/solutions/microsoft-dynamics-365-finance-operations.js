...
const MicrosoftDynamics365FinanceOperationsNew = () => {
  return (
    <>
      ...
      <title>Dynamics 365 Finance and Operations Partner | Dynamics Square CA</title>
        ...
        <link
          rel="canonical"
          href="https://www.dynamicssquare.ca/solutions/microsoft-dynamics-365-finance-operations/"
        />
        <meta property="og:locale" content="CAD" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Dynamics 365 Finance and Operations Partner | Dynamics Square CA" />
            ...
            <div className="row">
              <div className="col-xl-4 col-lg-4 col-md-6 d-flex">
                <div className="card-five">
                  <div className="pic">
                    <a href="#exampleModal" data-bs-toggle="modal"><Image src="/img/serv-img-1.jpg" alt="Implementation" width={826} height={368} /></a>
                  </div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 d-flex">
                <div className="card-five">
                  <div className="pic">
                    <a href="#exampleModal" data-bs-toggle="modal"><Image src="/img/serv-img-3.jpg" alt="Support Services" width={827} height={368} /></a>
                  </div>
                  <div className="info-card">
                    <h3>Reliable Ongoing Support</h3>
                    <p>Leverage ongoing support and active maintenance services to ensure optimal performance.</p>
                    <div className="act-bb">
                      <a href="#exampleModal" data-bs-toggle="modal">Revive Business! <i className="bi bi-arrow-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <header className="section-header-new">
                  ...
                  <p>Dynamics Square, a leading <a href="/"><b>Microsoft Solutions Partner in Ontario</b></a>, is known for providing tailor-made Finance and Operations service with a 360° approach, technical expertise, and competitive pricing.</p>
                </header>
              </div>
            </div>
            ...
            <div className="row g-3">
              <div className="col-xl-6 col-md-6 d-flex">
                <div className="crad-six c-white">
                  ...
                  <p>We provide end-to-end Dynamics 365 Finance and Operations services to ensure your organization <b>maximizes ROI</b> from their technology investments.</p>
              ...
              <div className="col-xl-6 col-md-6 d-flex">
                ...
                <Image src="/img/icon-inner-81.png" alt="icon-inner-80" width={48} height={48} />
                  ...
                  <p>Dynamics Square provides customized Dynamics F&O solutions for diverse industries such as <b>manufacturing, healthcare, retail,</b> and <b>financial services</b>.</p>
...
export default MicrosoftDynamics365FinanceOperationsNew;

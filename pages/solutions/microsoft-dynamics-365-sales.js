              ...
              <hr className="mob-disp" />
                <div className="accordion" id="accnew">
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                      <p>The sales professional app is a modular app designed by Microsoft to empower your sales professionals and sales manager to seamlessly perform administration-related tasks by easily customizing tables, dashboards, forms, views, charts, and <Link href="/solutions/microsoft-power-platform/"><a>manage business processes without writing any code.</a></Link></p>
                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay">
                        <p>Using in-the-moment insights from this <Link href="/solutions/microsoft-dynamics-365-marketing/"><a>cloud-based sales management solution</a></Link>, you can establish strong relationships with your customers and create new opportunities in the times of disruptive market changes. </p>
                      </div>
                    </div>
                    <div className="why-solution-wrapper-inner">
                      <h3>
                ...
                <div className="col-lg-6 top-m">
                  <div className="why-solution-wrapper">
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay">
                        <p><Link href="/solutions/microsoft-power-automate/"><a>Automate your sales practices</a></Link>, empower your sales workforce with Dynamics 365 Sales' data intelligence, and access in-depth sales analytics in real-time to maximize your growth potential. </p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-8">
              <div className="accordion accordion-flush" id="faqlist1">
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                     <p>For the Dynamics Sales Enterprise plan, Dynamics 365 Sales is set to be executed both on-premises and in the <Link href="/solutions/azure-iot-internet-of-things/"><a>Azure cloud</a></Link>. When it comes to implementing a Sales Professional plan, only on-cloud facilitation is available.</p>
                    </div>
                  </div>
                </div>
                <div className="accordion-item">

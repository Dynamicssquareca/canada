                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                       <p>Integrate different Microsoft apps like Teams, <Link href="/solutions/microsoft-power-bi/"><a>Power BI</a></Link>, Outlook, Excel, and <Link href="/solutions/microsoft-dynamics-365-ai/"><a>Artificial Intelligence</a></Link> to understand more about your employees, customers, and partners while delivering out-of-the-box experiences.</p>
                      </div>
                    </div>
                  </div>
                  <hr />
            ...
            <div className="col-lg-8">
              <div className="accordion accordion-flush" id="faqlist1">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                     <p><Link href="/solutions/microsoft-dynamics-365/"><a>Microsoft Dynamics 365</a></Link> is a suite of cloud-based next-gen business apps that include various CRM, ERP modules and different productivity tools or add-ons.</p>
                    </div>
                  </div>
                </div>
                <div className="accordion-item">

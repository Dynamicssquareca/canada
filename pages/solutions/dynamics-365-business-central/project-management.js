                ...
                <div className="content-icons-modil-1">
                  <div className="content-inner-moil-1">
                    ...
                    <div className="cintent-right">
                      <p><b>Comprehensive Financial Oversight </b></p>
                  ...
                  <div className="content-inner-moil-1">
                    ...
                    <div className="cintent-right">
                      <p><b>Successful Project Delivery </b></p>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <div className="call-to-action-content">
                  <h3>Want to improve internal communication and complete the project before deadline? </h3>
                  ...
                  <div className="text-center m-o-t new-btn-nn">
                    <a
                      ...
                      className="btn-get-started scrollto"
                    >
                      <span>Connect with a Project Management Expert Today! </span>
                    </a>
                  </div>
                </div>
              </div>
        ...
        <section className="call-to-action-center hero-4">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <div className="call-to-action-content">
                  <h3>Do you want to streamline your project resource allocations and improve efficiency? </h3>
          ...
          <div className="container">
            <div className="row gx-5">
              <div className="col-lg-6 align-self-center">
                ...
                <p>Dynamics Square is a leading <a href="/"><b>Microsoft Solutions partner in Vancouver</b></a> with 14+ years of experience. We help companies implement Business Central and excel in project management. We have: </p>
              </div>
              <div className="col-lg-6 align-self-center">
                <div className="content-icons-modil-1">
                  <div className="content-inner-moil-1 content-inner-moil-22">
                    ...
                    <div className="cintent-right">
                      <p><b>135+</b> well-trained and experienced consultants </p>
                    </div>
                  </div>
                  ...
                  <div className="content-inner-moil-1 content-inner-moil-22">
                    ...
                    <div className="cintent-right">
                      <p>Adequate training for proper solution utilization </p>
                    </div>
                  </div>
                  ...
                  <div className="content-inner-moil-1 content-inner-moil-22">
                    ...
                    <div className="cintent-right">
                      <p><b>24*7</b> reliable support availability </p>
                    </div>
                  </div>

...
const Healthcare = () => {
  return (
    <>
      <Head>
        <title>Dynamics 365 Business Central for Healthcare</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Dynamics 365 Business Central for Healthcare" />
              ...
              <div className="col-lg-9">
                <div className="hero-bnner-info text-center">
                  <div className="top-info">
                    <h1>Microsoft Dynamics 365 Business Central for Healthcare</h1>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <header className="section-header section-header-color">
                  <h2>Streamline Your Healthcare Business with D365 Business Central</h2>
                </header>
              </div>
            </div>
            <div className="row new-pd-02">
              ...
              <div className="col-lg-6 align-self-center">
                <div className="new-sol-con-side">
                  <p>Microsoft Dynamics 365 <a href="/solutions/dynamics-365-business-central/"><b>Business Central</b></a> for Healthcare offers real-time data to improve patients' care by making faster and more informed decisions. With a <b>360-degree view</b> of every patient, you can easily track their health and make decisions to improve it. </p>
                  <p>Also, you can manage multiple healthcare branches using a single integrated system that leads to increasing productivity, simplifying operations, reducing data entry, and <b>eliminating data silos</b>. </p>
                  <p>Other than healthcare operations, you can manage and connect different departments of a business while pushing the needle towards collaboration. </p>
        ...
        <section>
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <header className="section-header section-header-color">
                  <h2>Microsoft Business Central for Healthcare: Manage Patients and Boost Experience </h2>
                  <p>Microsoft Dynamics 365 Business Central offers several benefits to healthcare businesses, including excellent care and a positive patient experience. Some of its major benefits are: </p>
                </header>
              </div>
            </div>
            <div className="row">
            ...
            <div className="row bg-new-callaction m-o justify-content-center">
              <div className="col-lg-9">
                <div className="solution-new-caltoaction">
                  <h2>Empower your staff, enhance patient care, and optimize operations with Business Central</h2>
                  <p>Connect with a Microsoft partner and revolutionize your healthcare business.</p>
                  <a data-bs-toggle="modal"
        ...
        <section id="section2">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <header className="section-header section-header-color">
                  <h2>Major Features to Support Healthcare Business build a Brand </h2>
                  <p>Microsoft Dynamics 365 Business Central offers tailored solutions to healthcare entities to provide better service, patient care, and streamlined operations. </p>
                </header>
              </div>
            </div>
            ...
            <div className="row po-realtive">
              <div className="col-lg-7">
                <div className="call-to-action-three">
                  <h2>Ready to Transform Your Patient Care?</h2>
                  <p>Go for Business Central implementation and see the transformation.</p>
                  <a data-bs-toggle="modal"
        ...
        <section id="section1">
          <div className="container">
            ...
            <div className="row new-pd-01">
              ...
              <div className="col-lg-6 align-self-center">
                <div className="new-sol-con-side">
                  <h2>Aligning with Changing Healthcare Compliance: Today’s Biggest Challenge</h2>
                  <p>Healthcare companies work under constant duress to provide high-quality patient care while complying with stringent regulations. Not following these guidelines can lead to hefty fines and a lost reputation. </p>
                  <p>Besides compliance, healthcare providers don’t get complete visibility of medical records, medication schedules, lack automation, and face difficulties in offering remote healthcare services. </p>
                  <p><b>Microsoft Healthcare ERP</b> offers end-to-end solutions to healthcare providers, minimizing clinical errors and ensuring higher satisfaction. </p>
                  <p>Dynamics BC is a modern business solution that aligns with evolving requirements. It aligns with the changing healthcare compliance across global boundaries to accept the change. </p>
        ...
        <section id="section5">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <header className="section-header section-header-color">
                  <h2>Why Choose Dynamics Square for Healthcare in Business Central?</h2>

            ...
            <div className="row">
              ...
              <div className="col-xl-4 col-lg-4 col-sm-6 col-md-6 d-flex">
                <div className="card-two card-two-extra">
                  ...
                  <h3>Data security</h3>
                  <p>You can protect sensitive financial data with Microsoft’s <b>advanced encryption</b>, role-based access, and security filters. It will restrict unauthorized access and improve data security.</p>
                </div>
              </div>
            </div>

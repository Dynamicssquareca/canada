            ...
            <div className="col-lg-6">
              <div className="style-grid-1">
                <div className="style-grid-content">
                  ...
                  <p>A better understanding of customers about what they want is the key to increasing customer engagement. <Link href="/solutions/dynamics-365-customer-engagement/"><a>Dynamics 365 for Customer Engagement</a></Link> provides actionable insights to increase the customer number.</p>
                </div>
              </div>
              ...
              <div className="style-grid-1">
                <div className="style-grid-content">
                  ...
                  <p>Strong collaboration among sales teams results in closing more deals. <Link href="/solutions/microsoft-dynamics-365-sales/"><a>Dynamics 365 Sales</a></Link> is the right sales management approach that seamlessly helps you win customers and turn them into real customers.</p>
                </div>
              </div>
              <div className="style-grid-1">
                <div className="style-grid-content">
                  <h3>Dynamics 365 Customer Service</h3>
                  <p>Winning customer loyalty is the first step towards transforming your business into a brand. Use <Link href="/solutions/microsoft-dynamics-365-customer-service/"><a>Dynamics 365 Customer Service</a></Link> to provide your customers with quick and unique customer service experience and win their loyalty for life.</p>
                </div>
              </div>
            </div>
          </div>

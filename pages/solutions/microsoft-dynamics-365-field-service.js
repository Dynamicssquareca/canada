                ...
                <div className="col-lg-6">
                  <div className="why-solution-wrapper">
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay">
                        <p>Enhance customer service with <b>Dynamics 365's</b> combined capabilities in <Link href="/solutions/dynamics-365-supply-chain-management/"><a>Supply Chain Management</a></Link> and <b>Field Service</b>.</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-8">
              <div className="accordion accordion-flush" id="faqlist1">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                     <p>Dynamics 365 suite of business apps is a pack of <Link href="/solutions/microsoft-dynamics-erp/"><a>powerful ERP (Enterprise Resource Planning)</a></Link>, <Link href="/solutions/microsoft-dynamics-crm/"><a>CRM (Customer Relationship Management)</a></Link>, and data visualization tools like <Link href="/solutions/microsoft-power-bi/"><a>Power BI (Business Intelligence)</a></Link>.</p>

            ...
            <div className="col-lg-8 col-md-8">
              <header className="section-header">
                ...
                <p>
                  ...
                  ,{" "}
                  <Link href="/solutions/microsoft-dynamics-365/mixed-reality/">
                    <a>Mixed Reality</a>
                  </Link>
                  ,{" "}
                  <Link href="/solutions/azure-machine-learning/">
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay">
                        <p>
                          ...
                          stores and{" "}
                          <Link href="/solutions/dynamics-365-customer-engagement/">
                ...
                <div className="col-lg-6 top-m">
                  <div className="why-solution-wrapper">
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay">
                        <p>Make it happen with connected commerce solutions to drive business outcomes, improving customer experiences (CX), stronger engagement, and fulfillment of e-commerce orders via a <Link href="/solutions/dynamics-365-supply-chain-management/"><a>supply chain that has fidelity</a></Link>.</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="row gy-4 p-9 justify-content-center">
            ...
            <div className="col-lg-6 col-md-6">
              <div className="box box-22">
                ...
                <div className="price">
                $5427.20(CAD)<span>per user/month</span>
                </div>
                <ul>
                  <li className="text-center">

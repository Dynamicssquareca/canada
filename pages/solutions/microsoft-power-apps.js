              ...
              <div className="finace-acc">
                <div className="accordion" id="accnew">
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        <p>You can easily build personalized and professional apps while simplifying the complex processes of a business. It comes with in-built <Link href="/solutions/microsoft-dynamics-365-ai/"><a>AI (Artifical Intelligence)</a></Link> to help you add advanced features to the apps with ease.</p>
                      </div>
                    </div>
                  </div>
                  <hr />
            ...
            <div className="col-lg-8">
              <div className="accordion accordion-flush" id="faqlist1">
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <p>Power Apps is part of the broader Microsoft Power Platform built on Azure cloud services. It is a quick app development platform and includes native capabilities for <Link href="/solutions/microsoft-dynamics-365-sales/"><a>Microsoft Dynamics Sales</a></Link>, Service, <Link href="/solutions/microsoft-dynamics-365-field-service/"><a>Field Service</a></Link>, <Link href="/solutions/microsoft-dynamics-365-marketing/"><a>Marketing</a></Link>, and Talent Acquisition Apps.</p>
                    </div>
                  </div>
                </div>
              </div>

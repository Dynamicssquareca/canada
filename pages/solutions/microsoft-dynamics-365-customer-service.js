          ...
          <div className="row justify-content-center">
            <div className="col-lg-8 col-md-8">
              <header className="section-header">
                ...
                <p>With this Saas CRM solution, you empower your employees with a single, unified view of the customer to successfully drive omnichannel efficiency. Increase time-to-value for all your business investments by integrating this <Link href="/solutions/microsoft-dynamics-crm/"><a>cloud-based customer relationship management (CRM) system</a></Link> and unlock new revenue streams, reduce waste, and accelerate inefficiencies.</p>
              </header>
            </div>
          </div>
        </div>
          ...
          <div className="row gy-4 p-9">
            <div className="col-lg-6 col-md-6">
              <div className="box box-22">
                ...
                <div className="price">
                $67.80(CAD)<span>per user/month</span>
                </div>
                <ul>
                  <li>

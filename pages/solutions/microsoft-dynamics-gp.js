  ...
  return (
    <>
      ...
      <title>Microsoft Dynamics GP: Finance & ERP Tool for SMBs</title>
        ...
        <meta property="og:image" content="https://www.dynamicssquare.ca/img/gpbanner.png" />
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="call-to-action-content">
                ...
                <p>Connect with our highly experienced team of Microsoft consultants to help you smoothly migrate your Dynamics GP data to Microsoft cloud. Or get advice on how <Link href="/solutions/dynamics-365-business-central/"><a>Business Central</a></Link> can be a robust alternative to Dynamics GP. Explore: <Link href="/dynamics-365-business-central-features/"><a>Dynamics 365 Business Central Features</a></Link></p>
                <div className="text-center m-o-t new-btn-nn">
                  <Link href="#exampleModal">
